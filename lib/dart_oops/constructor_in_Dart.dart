...
class ConstructorInDart extends StatelessWidget {

  const ConstructorInDart({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Constructor",style: TextStyle(
      ...
      children: [
        Container(
          ...
          child:  WebView(
            ...
            initialUrl: 'https://shebaabd24.blogspot.com/2022/02/constructor-in-dart.html',
